---
name: en-debug
description: "Reproduce a bug from telemetry: read structured logs, correlate by trace or request id, and return a hypothesis with file:line and a confidence score. Read-only. Trigger phrases: 'debug this trace', 'reproduce this error', 'walk this log', 'why did this fail in prod'."
---
