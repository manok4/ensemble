...
5. **Q&A loop.** Pull questions from `$ENSEMBLE_ROOT/references/socratic-questions.md`. **One per turn**, multiple-choice when natural. Stop when scope, constraints, and the riskiest assumption are clear.
...
11. **Write the design doc** to `docs/designs/YYYY-MM-DD-<topic>-design.md` using `$ENSEMBLE_ROOT/references/templates/design-doc-template.md`. Status: `open`.
