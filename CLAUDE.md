...
Memory files live at `~/.claude/projects/-Users-...-Ensemble/memory/`. Save user-preference and feedback memories there per `~/.claude/CLAUDE.md` global instructions; project-specific facts go in `docs/learnings/` instead.
