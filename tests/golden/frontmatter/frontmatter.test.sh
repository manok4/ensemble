...
fixtures=(
  ...
  "plan-active/invalid-destructive-order.md|docs/plans/active/FR45-test.md|unit.destructive-order"
  "plan-completed/valid.md|docs/plans/completed/FR42-test.md|"
  "learning/valid.md|docs/learnings/test-2026-04-29.md|"

  "learning/invalid-missing-required.md|docs/learnings/test-2026-04-29.md|frontmatter.required-field-missing"
  "learning/index-is-not-a-solution.md|docs/learnings/index.md|"
  "adr/valid.md|docs/decisions/0001-declare-files.md|"
  "adr/invalid-frontmatter.md|docs/decisions/0002-with-frontmatter.md|adr.has-frontmatter"
  "adr/invalid-no-invariants.md|docs/decisions/0003-no-invariants.md|adr.missing-invariants"
  "context/valid.md|docs/CONTEXT.md|"
  "context/invalid-no-ambiguities.md|docs/CONTEXT.md|context.missing-ambiguities"
