...
REF="$REPO_ROOT/shared/references/en-flow-pipeline.md"
...
if grep -qF 'Helper resolution.' "$FLOW"; then pass "en-flow has helper-resolution header"; else fail "en-flow missing helper-resolution header"; fi
