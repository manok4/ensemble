...
POLICY="$REPO_ROOT/references/peer-model-policy.md"
...
FLAGS="$REPO_ROOT/bin/ensemble-peer-flags"
INVOKE="$REPO_ROOT/bin/ensemble-peer-invoke"
CFGGET="$REPO_ROOT/bin/ensemble-config-get"
...
# ============================================================
assert_file_exists "$POLICY" "references/peer-model-policy.md exists"
...
# ============================================================
assert_file_exists "$FLAGS" "bin/ensemble-peer-flags exists"
...
# ============================================================
assert_file_exists "$CFGGET" "bin/ensemble-config-get exists"
