...
has "$REPORT" "host_model"               "the envelope carries host_model"
...
for reason in default-on explicit-flag no-peer-flag host-only-mode single-agent-fallback \
              ...
              peer-failed:auth peer-failed:unknown peer-failed:retry-exhausted peer-failed:died peer-failed:max-turns \
...
for reason in default-on dropped-model-fragment dropped-effort-fragment dropped-isolation-fragment \
              peer-failed:auth peer-failed:unknown peer-failed:retry-exhausted peer-failed:died peer-failed:max-turns; do
